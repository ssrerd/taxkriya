<template>
  <div class="container terms">
    ...
    <h1 class="mb-2" style="text-align:center;">  TERMS OF USE </h1>
...
<p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Zrepra Innovations Private Limited, doing business as Taxkriya ("Taxkriya", “we”, “us”, or “our”), concerning your access to and use of the https://taxkriya.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
14. Use a buying agent or purchasing agent to make purchases on the Site.
...
<p>These Terms shall be governed by and defined following the laws of India. Zrepra Innovations Private Limited and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.</p>
...
<p>Zrepra Innovations Private Limited</p>
<p>126/44, Appu street, Mylapore</p>
